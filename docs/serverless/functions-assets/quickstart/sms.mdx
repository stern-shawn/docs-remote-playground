...
⬇️ This table was completely auto-generated based on headers 🚀 (Add `## Table of contents` to any mdx file)
...
Just to check it out, here's [an external link](https://www.youtube.com/watch?v=dQw4w9WgXcQ), which should render fancily via Paste and open in a new tab.
